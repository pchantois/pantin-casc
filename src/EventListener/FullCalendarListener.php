...
use App\Entity\Site\Event as Events;
...
class FullCalendarListener
{
    ...
    public function loadEvents(CalendarEvent $calendar)
    {
        ...
        $bookings = $this->em->getRepository(Events::class)
            ->createQueryBuilder('b')
            ->andWhere('b.start BETWEEN :startDate and :endDate')
        ...
        foreach($bookings as $booking) {
            ...
            $bookingEvent = new Event(
                $booking->getLibelle(),
                $booking->getStart(),
                $booking->getEnd() // If the end date is null or not defined, it creates a all day event
            );
